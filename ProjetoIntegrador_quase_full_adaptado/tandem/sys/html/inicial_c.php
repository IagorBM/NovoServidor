...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="../css/inicial_c.css">
...
<body>
    <form action="inicial_c.php" method="post">
        <div class="barLat">
            <!-- The sidebar -->
            <div class="sidebar">
            ...
            <div id="slider">
                ...
                <br>
                <!-- Botão de Pesquisa -->
                <input type="text" id="barPesquisa" name="nome_produto">
    ...
    <script src="../java/barPesq.js"></script>
</body>
