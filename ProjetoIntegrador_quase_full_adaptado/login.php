...
<body>
    ...
    <div class="central">
        ...
        <form method="post" action="login.php">
            ...
            <!--======fiz o link para o esqueceu=======-->
            <a href="tandem/sys/html/esqueceu_email.html">Esqueceu sua senha?</a>
            <!--==================-->
...
if (isset($_POST["Entrar"])) {
    ...
    if ($consulta->execute()) {
        ...
        if ($indice == 1) {
            ...
            if ($_SESSION["tipo"] == 'C')
                header("location: tandem/sys/html/inicial_c.php");
            else
                header("location: tandem/sys/html/vendedortemp.php");
        } else {
            echo '
                    <script>
